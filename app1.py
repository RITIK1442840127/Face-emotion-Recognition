...
try:
    ...
    emotion_labels = ['Angry', 'Disgust', 'Fear', 'Happy', 'Neutral', 'Sad',
                      'Surprise']  # Emotion that will be predicted
except Exception:
...
def main():
    ...
    <h2 style="color:white;text-align:center;">Haar Cascade Object Detection</h2>
        ...
        st.write('''
                  ...
                  Linkedin:-https://www.linkedin.com/in/ritik-tiwari-42930612a/
    ...
    <h2 style="color:white;text-align:center;">Copyright © 2022 | Ritik Tiwari </h2>
    </div>
    </body>
        """
        st.markdown(html_temp, unsafe_allow_html=True)
